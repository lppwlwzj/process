...
function findAffectedSchedules(doctorId, room, startTime, callback, newEndTime) {
  ...
  db.query(sql, [doctorId, startTime, startTime, endTime, startTime, startTime], (err, results) => {
    if (err) {
      return callback(err);
    }
