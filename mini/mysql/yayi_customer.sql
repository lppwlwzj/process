...
CREATE TABLE `customer` (
  ...
  `fuzhenTime` varchar(100) DEFAULT NULL COMMENT '复诊日期',
  `doctor` varchar(100) DEFAULT NULL COMMENT '面诊医生',
   `problem` varchar(100) DEFAULT NULL COMMENT '问题',
  ...
  `tiepianRemark` varchar(100) DEFAULT NULL COMMENT '贴片备注',
  `nurse` varchar(100) DEFAULT NULL COMMENT '护士姓名',
  `CADImg` longtext DEFAULT NULL COMMENT 'CAD设计图',
  `checiImg`longtext DEFAULT NULL COMMENT '车瓷设计图',
  `shangciImg` longtext DEFAULT NULL COMMENT '上瓷设计图',
  `shangyou5Img` longtext DEFAULT NULL COMMENT '上瓷第5天设计图',
  `daodianImg` longtext DEFAULT NULL COMMENT '到店设计图',
  `shangyouImg` longtext DEFAULT NULL COMMENT '上釉设计图',
  `CAD` varchar(100) DEFAULT NULL COMMENT 'CAD设计师',
  `checi` varchar(100) DEFAULT NULL COMMENT '车瓷设计师',
  `shangci` varchar(100) DEFAULT NULL COMMENT '上瓷',
  `shangyou5` varchar(100) DEFAULT NULL COMMENT '上釉第五天质检人',
  `shangyou5Remark` varchar(100) DEFAULT NULL COMMENT '上釉第五天留言',
  `shangyou` varchar(100) DEFAULT NULL COMMENT '上釉',
  `CADRemark` varchar(100) DEFAULT NULL COMMENT 'CAD留言',
  `checiRemark` varchar(100) DEFAULT NULL COMMENT '车瓷留言',
  `shangciRemark` varchar(100) DEFAULT NULL COMMENT '上瓷留言',
  `shangyouRemark` varchar(100) DEFAULT NULL COMMENT '上釉留言',
  ...
  `qieduanLinearsOpen` varchar(255) DEFAULT NULL COMMENT '切端渐变层',
  `qieduanLinearsValue` varchar(255) DEFAULT NULL COMMENT '切端渐变层值',
  ...
  `adjust` int DEFAULT 0 COMMENT '是否可见',
  `toothSensitivity` int DEFAULT 0 COMMENT '是否牙齿敏感',
  PRIMARY KEY (`id`)
