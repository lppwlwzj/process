    ...
    <u--form labelWidth="auto" labelPosition="left" :model="form" ref="uForm" :rules="rules">
      <view class="info fc">
        ...
        <u-form-item label="账号" prop="usercount">
          <u--input :disabled="true" placeholder=" " disabledColor="#fff" v-model="form.usercount" border="none"
            inputAlign="left" suffixIcon="edit-pen" suffixIconStyle=" color: #dd524dab !important;"></u--input>
        </u-form-item>
        <u-form-item label="密码" prop="password">
          <view class="u-demo-block__content">
            ...
                <!-- #ifndef APP-NVUE -->
            <u-input placeholder=" " :password="!visible" disabledColor="#fff" v-model="form.password" border="none"
              inputAlign="left">
              <!-- #endif -->
              <!-- #ifdef APP-NVUE -->
              <u--input placeholder=" " :password="!visible" disabledColor="#fff" v-model="form.password" border="none"
                inputAlign="left">
                <!-- #endif -->
                <u-icon slot="suffix" @click="visible = !visible" size="18" color="#dd524dab"
                  :name="visible ? 'eye' : 'eye-off'"></u-icon>
                <!-- #ifndef APP-NVUE -->
            </u-input>
            <!-- #endif -->
            <!-- #ifdef APP-NVUE -->
        ...
        <view class="protocol-tip">
          <u-checkbox-group placement="column" v-model="protocolChecked">
            <u-checkbox shape="circle" activeColor="#dd524d" style="margin-right: 12rpx;" />
          </u-checkbox-group>
          已阅读并同意
